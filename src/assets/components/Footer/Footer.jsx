          ...
          <div className='w-full sm:w-1/2'>
            ...
            <div className='flex items-center gap-4 flex-wrap md:gap-8'>
              ...
              <span className='w-[40px] h-[40px]  mt-8 bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'>
                <a href='https://www.instagram.com/yajas_291/' className='text-gray-font-[500] text-[25px]'><i class="ri-instagram-line"></i></a>
              </span>
              <span className='w-[40px] h-[40px]  mt-8 bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'>
                <a href='https://github.com/yajas-menon' className='text-gray-300 font-[500] text-[25px]'><i class='ri-github-line'></i></a>
              </span>
      ...
      <div className='bg-[#1b1e29] py-3 mt-14'>
        <div className='container'>
          <div className='flex items-center justify-center sm:justify-between'>
            <div className='hidden sm:block'>
              <div className='flex items-center gap-[10px]'>
                <span className='w-[35px] h-[35px]  bg-white text-black text-[18px] font-[500]
                     rounded-full flex items-center justify-center'>Y</span>
            ...
            <div>
              <p className='text-gray-400 text-[14px]'>Copyright &copy; {year} <br /><b>Yajas Menon</b> </p>
            </div>
          </div>
        </div>
      </div>
