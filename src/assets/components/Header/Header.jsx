      ...
      <div className='container'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-4'>
            <a target ='_blank' href= 'https://drive.google.com/file/d/1YVxakz7rFaDQF_rlosYq21pP46d0SFUE/view?usp=drivesdk' download='Resume'><button className=' md:flex md:items-center mx-4 my-6 md:my-0 flex items-center gap-2 text-white font-[600] border border-solid
